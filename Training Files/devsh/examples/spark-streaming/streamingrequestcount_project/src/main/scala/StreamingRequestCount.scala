// test using the ~/training_materials/devsh/examples/spark/spark-streaming/streamtest.py script
// for example: python ~/training_materials/devsh/scripts/streamtest.py localhost 1234 20 $DEVDATA/weblogs/*
